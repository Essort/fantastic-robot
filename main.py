...
# Get argument first - mobilenet-ssd_openvino_2021.2_6shave.blob
...
socketserver.TCPServer.allow_reuse_address = True # this is useful for rapid testing, and modifying, because it can be restarted fast
server_TCP = socketserver.TCPServer(('localhost', 18637), TCPServerRequest)
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        for detection in detections:
            ...
            server_TCP.datatosend = json.dumps([{'camera': 0, 'detected': label,
